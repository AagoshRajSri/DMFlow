...
export default function WebhookTest() {
  ...
  return (
    <div className="text-sm space-y-3">
      ...
      <div className="text-xs text-gray-400">Webhook testing requires a valid server-side signature. Use the backend/Postman test flow for signed webhook testing.</div>
    </div>
  )
}
